...
>
	...
	<main class="max-w-[var(--maxw)] mx-auto px-[var(--gutter)] pb-20">
		...
		<section class="relative pt-[52px] pb-16" data-screen-label="hero">
			<OxideLattice />
			<div class="absolute top-1 right-0 z-[1] text-right pointer-events-none select-none text-[11.5px] leading-[1.7] tracking-[0.02em] text-crt-faint flex flex-col max-[820px]:hidden" aria-hidden="true">
			...
			{#if bootComplete}
				<p class="text-[clamp(18px,2.6vw,26px)] text-foreground m-0 mb-3.5 font-medium min-h-[1.4em] reveal">
